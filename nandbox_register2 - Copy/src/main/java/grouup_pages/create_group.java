...
public class create_group extends Base1_page {
    ...
    private By Payment_setting = By.xpath("/html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav-content/div/div[2]/div/div/app-sub-chat-form/div/form/div[5]/div/app-abstract-item-form/label/div/div[1]")   ;
	...
	{
		wait_elements (new_driver , 100 ,  Payment_setting  );
		return new_driver.findElement(Payment_setting).getText();
	}
