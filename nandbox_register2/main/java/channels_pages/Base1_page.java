...
public class Base1_page {
	...
	public Base1_page(WebDriver driver4)
	{
		new_driver = driver4 ;
...
//public Base_page(WebDriver driver2) {
	...
	//}
	public void scroll_down (WebDriver driver4)
	  {
		  JavascriptExecutor java = (JavascriptExecutor) driver4; // bay3ml casting lel interface JavascriptExcuter le webDriver r
		   java.executeScript("scroll(0,250)")   ;               // dh basta5dmo law 3ayz a run ay 7aga feha javascript code through selenium
	  }
	  public void wait_elements (WebDriver driver4 ,int time ,By element_name)
	  {
		  WebDriverWait wait =new WebDriverWait(driver4,time);
