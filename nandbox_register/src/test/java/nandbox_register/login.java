 ...
 public void create_channel() throws InterruptedException {
	//  tigoDriver.manage().timeouts().implicitlyWait(10,TimeUnit.SECONDS );
	  ...
	  tigoDriver.findElement(By.xpath("/html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav/div/app-side-menu/div[9]/div/div/div[1]")).click();//click on channels
	                         //    /html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav/div/app-side-menu/div[9]/div/div/div[1]
	  Thread.sleep(2000); 
...
//	  tigoDriver.findElement(By.xpath("/html/body/app-app/app-dashboard/div/app-layout/mat-sidenav-container/mat-sidenav-content/div[2]/div/div/div/app-sub-chats/div/app-sub-chat-form-image/app-form-frame/div/div[2]/div[2]/div/app-border-btn[2]/button/span")).click();//cancel button
  ...
  @Test(priority=2)
  public void create_event() throws InterruptedException, AWTException {
	  WebDriverWait wait = new WebDriverWait(tigoDriver,80); 
	  wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav-content/div/div[1]/mat-sidenav/div/app-side-menu/div[14]/div/div/div[1]")));;
	  Thread.sleep(3000);
	 ...
	 ///  /html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav/div/app-side-menu/div[15]/div/div/div[1]
	  tigoDriver.findElement(By.xpath("/html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav-content/div/div[1]/mat-sidenav/div/app-side-menu/div[14]/div/div/div[1]")).click();//event section
	                             //   /html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav/div/app-side-menu/div[16]/div/div/div[1]
	  Thread.sleep(3000);
	  WebDriverWait wait2 = new WebDriverWait(tigoDriver,40); 
	  wait2.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav-content/div/div[2]/div/div/app-events/app-list-style-bar-frame/div/div/div[1]/div[2]/app-border-btn/button/span")));
	  tigoDriver.findElement(By.xpath("/html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav-content/div/div[2]/div/div/app-events/app-list-style-bar-frame/div/div/div[1]/div[2]/app-border-btn/button/span")).click();//create event
	 ...
	 tigoDriver.findElement(By.xpath("/html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav-content/div/div/div/div/app-events/app-event-form/div/form/app-headerfull-frame/div/div[2]/app-selector-input-location/div/div/div/div[4]")).click();//cairo festival city
	  ...
	  Thread.sleep(3000);
	   ...
	   Thread.sleep(3000);
//	WebElement logo =  tigoDriver.findElement(By.linkText("./assets/svg/app-sections.svg#icon-edit-frame"));
	//   xlink:href="./assets/svg/app-sections.svg#icon-edit-frame"
...
//int logoHeight = logo.getSize().getHeight(); 
          // logo.click();
	   Thread.sleep(3000);
	   tigoDriver.findElement(By.xpath("/html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav-content/div/div/div/div/app-events/div/div/app-event-cell[1]/app-cell-frame/div/div/div[1]/div[3]")).click();
	  // /html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav-content/div/div/div/div/app-events/div/div/app-event-cell[1]/app-cell-frame/div/div/div[1]/div[3]
	   Thread.sleep(3000);
	   tigoDriver.findElement(By.xpath("/html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav-content/div/div[2]/div/div/app-events/div/div/app-event-cell[1]/app-cell-frame/div/div/div[2]/div[1]/span[1]/app-edit-btn")).click();//edit button of first event cell 
                             //        /html/body/app-app/app-dashboard/div/app-layout/div/mat-sidenav-container/mat-sidenav-content/div/div/div/div/app-events/div/div/app-event-cell[1]/app-cell-frame/div/div/div[2]/div[1]/span[1]/app-edit-btn
